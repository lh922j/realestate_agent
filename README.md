...
에이전트가 질문 의도에 맞는 도구를 선택하는지 26개 질문으로 측정.

| 정확도 | 실패 케이스 |
|--------|------------|
| **96.2%** (25/26) | "서초구 살기 좋아?" — 질문이 모호해 도구 미호출 |

### 가격 예측 정확도

단지 단위 80/20 분리 (테스트셋 = 학습에 미포함 단지 3,254개 · 196,035건).

| MAE | RMSE | R² | MAPE |
|-----|------|----|------|
| 16,507만원 (1.65억) | 28,740만원 | **0.714** | 23.6% |
